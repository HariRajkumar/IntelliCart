...
const ForgotPassword = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-background px-4 overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-warning/15 blur-[120px] pointer-events-none" />
        ...
        {step === 1 ? (
          <form onSubmit={handleSendOTP}>
            <div className="text-center mb-6">
              <div className="inline-flex p-3.5 bg-warning/10 rounded-2xl text-warning mb-4">
              ...
              <p className="text-sm text-muted">Enter your email to receive a password reset OTP</p>
            </div>
          ...
          <form onSubmit={handleResetPassword}>
            <div className="text-center mb-6">
              ...
              <h1 className="text-2xl font-bold text-text mb-2">Choose New Password</h1>
            ...
            <div className="flex flex-col items-center gap-3 mt-6">
              <button
                ...
                className="text-xs font-semibold text-muted hover:text-text transition-colors flex items-center gap-1.5"
              >
