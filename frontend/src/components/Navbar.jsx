        ...
        <div className="flex items-center gap-4">
          ...
          {isAuthenticated ? (
            <>
              <Link 
                to="/chatbot" 
                className={`font-semibold text-sm transition-colors duration-200 hover:text-primary flex items-center gap-1.5 ${
                  isActive("/chatbot") ? "text-primary" : "text-muted"
                }`}
              >
                      ...
                      {user?.role === "admin" && (
                        <>
                          <Link
                            ...
                            className="flex items-center gap-2 px-3 py-1.5 text-xs font-bold text-primary hover:bg-primary/10 rounded-xl transition-colors duration-200"
                          >
