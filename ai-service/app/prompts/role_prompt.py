...
Rules:
1. "customer" role can perform shopping actions: view products, search catalog, manage their own cart, view/create their own orders, write reviews for products, view/edit their own profile.
2. "customer" role CANNOT perform administrative actions, such as: deleting/modifying/creating products, deleting/modifying categories, viewing all users' accounts, viewing system logs, changing roles, accessing general sales reports or orders of other users.
